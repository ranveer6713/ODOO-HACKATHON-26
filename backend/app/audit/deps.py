"""Integration seam between the Audit module and the shared foundation.

The Audit module is a self-contained vertical slice. It does **not** own the
declarative ``Base``, the database session, or JWT/auth — those belong to the
...
from app.audit.exceptions import AuthenticationError, PermissionDeniedError
