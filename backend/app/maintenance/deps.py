"""Integration seam between the Maintenance module and the shared foundation.

The Maintenance module is a self-contained vertical slice. It does **not** own the
...
they are present and fall back to a local, standalone setup otherwise, so this
...
from app.maintenance.exceptions import AuthenticationError, PermissionDeniedError
